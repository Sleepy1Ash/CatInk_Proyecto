...
// ====================================
// 2️⃣ Últimas noticias (top 5) con categorías
// ====================================
                ...
                ?>
                    <div class="col">
                        <div class="card h-100 shadow-sm news-card">
                            ...
                            <div class="card-body">
                                <?php foreach(array_filter(array_map('trim', explode(',', $noticia['categorias'] ?? ''))) as $cat): ?>
...
// ====================================
// 1️⃣ Estadísticas de vistas y tiempo
// ====================================
function loadGlobalStats() {
    ...
    fetch(`./../controllers/obtener_estadisticas_globales.php?${params}`)
        ...
        .then(data => {
            ...
            renderAreaChart('globalChartTiempo', data, 'tiempo', 'Tiempo de visualización (s)');
        })
        .catch(console.error);
}
// ====================================
// 2️⃣ Estadísticas de likes y región
// ====================================
function loadLikesStats() {
    ...
    fetch(`./../controllers/obtener_estadisticas_likes.php?fecha_inicio=${fechaInicio}&fecha_fin=${fechaFin}`)
        ...
        .then(data => {
            ...
            renderBarChart('globalChartLikesRegion', data.geo.estados, 'Likes por Estado');
        })
        .catch(console.error);
}
// ====================================
...
function renderBarChart(canvasId, geoData, title) {
    ...
    charts[canvasId] = new Chart(ctx, {
        type: 'bar',
        data: {labels: geoData.labels, datasets: [{label: title, data: geoData.values, borderWidth:1}]},
